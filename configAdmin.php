    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">SOW</small></h1>
            </div>
            <!-- Nav tabs -->
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label>Detalle</label>
                                <input type="text" class="form-control"  placeholder="Detalle" required maxlength="30" name="prod-model">
                              </div>
                              <div class="form-group">
                                <label>Descripcion Corta</label>
                                <input type="text" class="form-control"  placeholder="Descripcion" required maxlength="30" name="prod-marca">
                              </div>
                              <div class="form-group">
                ...
                <div role="tabpanel" class="tab-pane fade" id="Pedidos">
                    <div class="row">
                        <div class="col-xs-12">
                             ...
                             <div class="panel panel-info">
                              ...
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      <thead class="">
                                          <tr>
                                              <th class="text-center">NumPedido</th>
                                      ...
                                      <tbody>
                                        ...
                                        <?php 
                                            $conexion=mysqli_connect('sql110.epizy.com','epiz_23655023','Bernabe03','epiz_23655023_store');
                                          ?>

                             <div class="panel panel-info">
                               <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>     Detalle de Pedidos</h3></div>
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      <thead class="">
                                          <tr>
                                              <th class="text-center">NumPedido</th>
                                              <th class="text-center">CodigoProd</th>
                                              <th class="text-center">Platillo</th>
                                              <th class="text-center">CantidadProductos</th>
                                          </tr>
                                      </thead>
                                      <tbody>
                                         
                                              <?php 
                                              $sql="SELECT detalle.NumPedido, detalle.CodigoProd,producto.NombreProd, detalle.CantidadProductos FROM detalle, producto where detalle.CodigoProd = producto.CodigoProd;";
                                              ...
                                              <tr>
                                                <th><?php echo $mostrar['NumPedido'] ?></th>
                                                <th><?php echo $mostrar['CodigoProd'] ?></th>
                                                <th><?php echo $mostrar['NombreProd'] ?></th>
                                                <th><?php echo $mostrar['CantidadProductos'] ?></th>
                                              </tr>
                                            <?php 
                                            }
                                             ?>
                               ...
                               <div class="panel panel-info">
                               <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>     Clientes</h3></div>
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      <thead class="">
                                          <tr>
                                      ...
                                      <tbody>
                                              ...
                                              <?php 
                                              $sql="SELECT NIT, NombreCompleto, Apellido, Direccion, Email FROM cliente;";
                                              $result=mysqli_query($conexion,$sql);
                                              ...
                                              <tr>
                                                ...
                                                <th><?php echo $mostrar['NombreCompleto'] ?></th>
                          ...
                          <div class="panel panel-info">
                               <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>     Productos</h3></div>
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      <thead class="">
                                          <tr>
                                              <th class="text-center">CodigoProd</th>
                                              <th class="text-center">NombreProd</th>
                                              <th class="text-center">Precio</th>
